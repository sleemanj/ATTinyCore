...
//   #define USE_SERIAL_TYPE SERIAL_TYPE_SOFTWARE
// The 4/9 do not have an ADC so they can't use this anyway.
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// The 4/9 do not have an ADC, so there is no reference at all.
// #define DEFAULT (0)
...
// This is meaningless on the 4/9, but just in case
// we will leave it anyway, you can probably call analogRead()
// and it will do a digitalRead() probably...
...
// 4/9 has no ADC, so no Ax defines either...
