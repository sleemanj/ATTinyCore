...
void init(void)
{
  #if (F_CPU!=8000000L && F_CPU!=1000000L && CLOCK_SOURCE==0)
  // Adjustment of prescale needed
  // No cli() - interrupts have not yet been enabled when init() is called.
    #ifdef CCP
      ...
      #elif (F_CPU ==2000000L)
        CLKPR=2; //prescale by 2 for 4MHz
      #else
        #error "F_CPU set to value which cannot be generated by prescaling the internal oscillator"
      #endif
    #endif
    ...
    #elif (F_CPU != 16500000L && CLOCK_SOURCE== 6 && (defined(PRETUNED165)))
      ...
      #else
        #error "F_CPU set to value which cannot be generated by prescaling the PLL"
      #endif
    #endif
